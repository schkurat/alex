...
if ($provider != 0) {
    $ath1 = mysql_query("INSERT INTO resipt_all(`ID_RESIPT`,`SKOD`,`PROVIDER`,`PRODUCT`,`NUMBER`,`OPT`,`SUM`,`DT`,`STATUS`,`KA`) "
        . "VALUES('$recipt','$skod','$provider','$product','$kol','$opt','$sum',NOW(),'2','$kap');");
    if (!$ath1) {

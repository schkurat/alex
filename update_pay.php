...
$ath1=mysql_query("UPDATE invoicespay SET sm_bal='$smbal',sm_cash='$smcash',dt='$dt' WHERE id='$kl' AND dl='1'");
...
header("location: store.php?filter=invoice_open&kl=".$ivoice."&provider=".$provider);
?>
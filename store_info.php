...
<form action="store.php" name="myform" method="get">
    <table align="center" class="zmview">
        <tr>
            <th colspan="2" align="center">Склад</th>
        </tr>
        <tr>
            <td>Період</td>
            <td>
        ...
        <tr>
            ...
            <td>
                ...
                <input id="r4" type="radio" name="stat" value="4"/><label for="r4">Повернуто від клієнта</label><br>
                <input id="r5" type="radio" name="stat" value="5"/><label for="r5">Повернення постачальнику</label>
            </td>
        </tr>
        <tr>

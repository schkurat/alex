    ...
    <tr>
        <td class=men>
            ...
            <ul class="topnav">
                <li><a href="#">Склад</a>
                    <ul>
                        <li <?php echo $pruhid; ?>><a href="store.php?filter=new_invoice">Прихід товару</a></li>
                        <!--product_to_sklad&stat=1-->
                        <li <?php echo $prodaj; ?>><a href="store.php?filter=product_to_customer">Реалізація товару</a>
                        </li>

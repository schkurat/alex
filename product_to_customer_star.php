...
$sql2="SELECT SUM(`NUMBER`) AS PRIHOD FROM `store` WHERE `SKOD`='".$aut["SKOD"]."' AND DT>='$dt_bal' AND `STATUS`='1'";
$atu2=mysql_query($sql2);
  while($aut2=mysql_fetch_array($atu2))
 {
...
<td><a href="del_product_recipt.php?kl='.$aut["ID"].'&recipt='.$recipt.'&money='.$money.'"><img src="images/b_drop.png" border="0"></a></td>

...
<td align="center">'.$aut["SKOD"].'<a href="print_kod.php?npr='.$npr.'&kpr='.$kpr.'&time1='.$time1.'&time2='.$time2.'&stat='.$stat.'&provider='.$provider.'&scd='.$aut["SKOD"].'"><img src="images/print.png" border="0"></a></td>	
    <td>'.$aut["PROVIDER"].'</td>
